//
//  CrossAdsInterstitialTableViewCell.swift
...
class CrossAdsInterstitialTableViewCell: CrossAdsBaseTableViewCell {
    ...
    static var defaultHeight = 460.0
    ...
    func updateUI() {
        ...
        heighConstraint.constant = presentation.adHeight ?? CrossAdsInterstitialTableViewCell.defaultHeight
